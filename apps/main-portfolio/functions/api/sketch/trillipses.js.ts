// Cloudflare Function for trillipses.js
...
export async function onRequestGet(context: {
  ...
  try {
    ...
    console.log('Cloudflare Function - Sketch: trillipses.js');
    ...
    const sketchPath = '/assets/sketches/trillipses.js';
    ...
    if (!sketchResponse.ok) {
      ...
      return new Response('Sketch not found: trillipses.js', { 
        status: 404,
...
<head>
    ...
    <title>P5.js Sketch - trillipses.js</title>
