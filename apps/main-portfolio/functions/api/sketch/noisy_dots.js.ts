// Cloudflare Function for noisy_dots.js
...
export async function onRequestGet(context: {
  ...
  try {
    ...
    console.log('Cloudflare Function - Sketch: noisy_dots.js');
    ...
    const sketchPath = '/assets/sketches/noisy_dots.js';
    ...
    if (!sketchResponse.ok) {
      ...
      return new Response('Sketch not found: noisy_dots.js', { 
        status: 404,
...
<head>
    ...
    <title>P5.js Sketch - noisy_dots.js</title>
