// Cloudflare Function for circles_color.js
...
export async function onRequestGet(context: {
  ...
  try {
    ...
    console.log('Cloudflare Function - Sketch: circles_color.js');
    ...
    const sketchPath = '/assets/sketches/circles_color.js';
    ...
    if (!sketchResponse.ok) {
      ...
      return new Response('Sketch not found: circles_color.js', { 
        status: 404,
...
<head>
    ...
    <title>P5.js Sketch - circles_color.js</title>
