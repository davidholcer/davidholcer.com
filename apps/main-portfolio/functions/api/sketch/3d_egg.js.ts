// Cloudflare Function for 3d_egg.js
...
export async function onRequestGet(context: {
  ...
  try {
    ...
    console.log('Cloudflare Function - Sketch: 3d_egg.js');
    ...
    const sketchPath = '/assets/sketches/3d_egg.js';
    ...
    if (!sketchResponse.ok) {
      ...
      return new Response('Sketch not found: 3d_egg.js', { 
        status: 404,
...
<head>
    ...
    <title>P5.js Sketch - 3d_egg.js</title>
