// Cloudflare Function for spheres.js
...
export async function onRequestGet(context: {
  ...
  try {
    ...
    console.log('Cloudflare Function - Sketch: spheres.js');
    ...
    const sketchPath = '/assets/sketches/spheres.js';
    ...
    if (!sketchResponse.ok) {
      ...
      return new Response('Sketch not found: spheres.js', { 
        status: 404,
...
<head>
    ...
    <title>P5.js Sketch - spheres.js</title>
