// Cloudflare Function for leveled_circles.js
...
export async function onRequestGet(context: {
  ...
  try {
    ...
    console.log('Cloudflare Function - Sketch: leveled_circles.js');
    ...
    const sketchPath = '/assets/sketches/leveled_circles.js';
    ...
    if (!sketchResponse.ok) {
      ...
      return new Response('Sketch not found: leveled_circles.js', { 
        status: 404,
...
<head>
    ...
    <title>P5.js Sketch - leveled_circles.js</title>
