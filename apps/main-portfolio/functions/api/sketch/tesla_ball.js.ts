// Cloudflare Function for tesla_ball.js
...
export async function onRequestGet(context: {
  ...
  try {
    ...
    console.log('Cloudflare Function - Sketch: tesla_ball.js');
    ...
    const sketchPath = '/assets/sketches/tesla_ball.js';
    ...
    if (!sketchResponse.ok) {
      ...
      return new Response('Sketch not found: tesla_ball.js', { 
        status: 404,
...
<head>
    ...
    <title>P5.js Sketch - tesla_ball.js</title>
